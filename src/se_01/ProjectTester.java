...
public class ProjectTester {
  Project simple_example, simple_cycle, complex_cycle, complex_graph, tree;
  ...
  @Test
  public void test_tree_1(){
	  assertTrue(tree.isWellSorted(new String[]{"A", "C", "F", "G", "B", "E", "D"}));
  }
  
  @Test
  public void test_tree_2(){
	  assertFalse(tree.isWellSorted(new String[]{"A", "B", "D", "E", "F", "C", "G"}));
  }
}
